...
extension UITableView {
    ...
    func dequeueReusableCell<Cell: ReusableCell>(_ type: Cell.Type = Cell.self, for indexPath: IndexPath) -> Cell {
        self.dequeueReusableCell(withIdentifier: type.reusableIdentifier, for: indexPath) as! Cell
    }

    func reuse<Cell: ReusableCell>(_ type: Cell.Type = Cell.self, input: Cell.Input, for indexPath: IndexPath) -> Cell {
