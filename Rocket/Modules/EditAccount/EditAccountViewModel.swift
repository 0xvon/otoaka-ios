...
class EditAccountViewModel {
    ...
    func editAccount(id: User.ID, name: String, biography: String?, thumbnail: UIImage?, role: RoleProperties) {
        let imageUrl: String = "aaa"
        let user = User(id: id, name: name, biography: biography, thumbnailURL: imageUrl, role: role)
