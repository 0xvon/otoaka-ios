...
final class EditLiveViewController: UIViewController, Instantiable {
    ...
    func setup() {
        ...
        let constraints: [NSLayoutConstraint] = [
            ...
            livehouseInputView.topAnchor.constraint(equalTo: liveTitleInputView.bottomAnchor, constant: 24),
    ...
    func createLive() {
        ...
        viewModel.editLive(title: title, liveId: input.id, livehouse: livehouse, openAt: self.openAt, startAt: self.startAt, endAt: self.endAt, thumbnail: self.thumbnail)
    }
}
