...
final class UserRankingCell: UITableViewCell, ReusableCell {
    typealias Input = UserRankingCellContent.Input
    typealias Output = UserRankingCellContent.Output
    static var reusableIdentifier: String { "UserRankingCell" }
    
    private let _contentView: UserRankingCellContent
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        _contentView = UserRankingCellContent()
...
class UserRankingCellContent: UIButton {
    typealias Input = (
        user: User,
        count: Int,
        unit: String,
    ...
    func inject(input: Input) {
        ...
        userNameLabel.text = input.user.name
