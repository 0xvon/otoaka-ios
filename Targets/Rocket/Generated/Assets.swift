...
internal enum Asset {
  ...
  internal static let bellIcon = ImageAsset(name: "bellIcon")
  ...
  internal static let selectedBellIcon = ImageAsset(name: "selectedBellIcon")
  internal static let selectedGuitarIcon = ImageAsset(name: "selectedGuitarIcon")
  internal static let selectedMusicIcon = ImageAsset(name: "selectedMusicIcon")
