...
internal enum Asset {
  ...
  internal static let dpf = ImageAsset(name: "dpf")
  ...
  internal static let ssSearchGroup = ImageAsset(name: "ss_search_group")
  internal static let ssSearchLive = ImageAsset(name: "ss_search_live")
