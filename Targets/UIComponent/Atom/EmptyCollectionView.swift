...
public final class EmptyCollectionView: UIStackView {
    public enum EmptyType: String {
        case feed = "フィード一覧がまだありません。ここにはフォローしているバンドのフィードが表示されます。試しにバンドをフォローしてみましょう。"
        case feedBand = "フィード一覧がまだありません。ここにはバンドのMV・好きな音楽・人生をフィードとして共有し、ファンがそれを楽しむことができます。試しにフィードを投稿してTwitterでシェアしてみましょう。"
