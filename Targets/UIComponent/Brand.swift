...
public enum Brand {
    ...
    public static func color(for color: Color) -> UIColor {
        ...
        case .background(.primary):        return #colorLiteral(red: 0.07843137255, green: 0.07843137255, blue: 0.1019607843, alpha: 1) // #14141A
        ...
        case .background(.milder):         return #colorLiteral(red: 0.2549019608, green: 0.2509803922, blue: 0.2705882353, alpha: 1) // #414045
